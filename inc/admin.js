            ...
            return new Promise((s, f) => {
                ...
                conn.query(
                    ...
                    SELECT
                        ...
                        (SELECT COUNT(*) FROM tb_sala) AS nrsala,
                    ...
                    if (err) {
                        ...
                        if (!files.photo) {
                            ...
                            `;
                                ...
                                query = `
                                INSERT INTO tb_sala (title, description, price, photo)
                                VALUES(?, ?, ?, ?)
                            `;
                                params = [
                                    fields.title,
                ...
                form.parse(req, function (err, fields, files) {
                    ...
                    if (parseInt(fields.id) > 0) {
                        ...
                        query = `
                                ...
                                SET name = ?, email = ?, people = ?, date = ?, espaco = ?, telefone = ?
                                WHERE id = ?
                            `;
                        params = [
                            fields.name,
                        ...
                        query = `
                                INSERT INTO tb_reservations (name, email, people, date, espaco, telefone)
                                VALUES(?, ?, ?, ?, ?, ?)
                            `;
                        params = [
                            fields.name,
